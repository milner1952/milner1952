...
void REDUCTION::Init(WORD pix_of_string, WORD lf, WORD rg, BYTE binn )
 {
        ...
        if(pix_of_string == 576)
        {
            ...
            case 3: GetNumLevels(32); num_string_of_reduction_data = 16; num_adc = 9; num_pix_in_string = (576); break;
            case 4: GetNumLevels(32); num_string_of_reduction_data = 16; num_adc = 9; num_pix_in_string = (576);break;
