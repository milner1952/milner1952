...
char buf[10];
            ...
            catch(EXP_ERROR &e)
            {
                ...
                //e.ErrorShow("test_dll_InitFn","p_test_dlll", "test_dll_Show_s_dw");
                return 1;
            }
return 0;
}
...
return 0;
        ...
        catch(EXP_ERROR &e)
        {
           ...
           // e.ErrorShow("p_test_dlll", "test_dll_Show_s_dw_s");
            return 1;
        }
return 0;
}
...
char t[20];
        ...
        catch(EXP_ERROR &e)
        {
          ...
          //  e.ErrorShow("p_test_dlll", "test_dll_Show_s_us");
            return 1;
        }
return 0;
}
...
return 0;
   ...
   char b[100]; memset(b, 0, 100);
        ...
        catch(EXP_ERROR &e)
        {
            ...
            //e.ErrorShow("p_test_dlll", "test_dll_Show_s_d");
            return 1;
        }
return 0;
}
...
char buf[10];
        ...
        catch(EXP_ERROR &e)
        {
            ...
            //e.ErrorShow("p_test_dlll", "test_dll_Show_s_bt");
            return 1;
        }
...
char buf[10];
        ...
        catch(EXP_ERROR &e)
        {
            ...
            //e.ErrorShow("p_test_dlll", "test_dll_Show_s_dw_s_dw");
            return 1;
        }
return 0;
}
...
return 0;
        ...
        catch(EXP_ERROR &e)
        {
           ...
           // e.ErrorShow("p_test_dlll", "test_dll_Show_s_s");
            return 1;
        }
return 0;
}
