...
QWidget* main_Init(string *dir_work, string *patch_ini,QWidget*, QScrollArea**);
...
QWidget    *w_paint =  main_Init(&s_dir,&patch_ini,&wnd,&sa);
    wnd.show();
...
//
//--------------------------------------------------------------------
QWidget *main_Init(string * dir_work, string *patch_ini,QWidget *parent, QScrollArea **sa)
{
QString e;
string p = *dir_work;
