...
//Модуль  PLL
`ifndef _576_pix
                                	//div = 171, mul = 836, f =  122,222мГц, при f_in = 25мГц  	t_str = 2,0 mC	/ 3,8mC 
...
PLL_5 pll_brd(OSC1,PLL_OSC_576);	//div 61 mul 100     fout =  40,972         f_in   25 t_str    = 5,788mC
											//		214		 400,	fout =   49,43181		  f_in   25 t_str    = 5,0 mC   // последний вариант
										   //div = 9, mul = 22, fout =  61,111мГц, при f_in = 25мГц t_str = 3,97mC  	 					
