...
assign _TRIG = ~((~_TRIG_BOARD0));
assign END = END_BOARD0;
...
begin
	if(RES_HARD_RF13 == 1) 
	begin
		INTERUPT_1_TOO_SILABS_P03 <= 1;   Count32trigTooSilabs <= 4'h0;  
	end   
	else
	
		if(MTR_RST  == 0) 
		begin
			INTERUPT_1_TOO_SILABS_P03 <= 1;   Count32trigTooSilabs <= 4'h00; 
		end
		else
		if(trig == 1)
		begin
			Count32trigTooSilabs <= Count32trigTooSilabs + 4'h1;
			if(Count32trigTooSilabs == 4'h0f) 
			begin
...
ADRES_OUT_MD  addres_out(RES_HARD_RF13,OSC1, CS_READ_MTR_RF7,  /*MTR_RST*/INT_RESET_RE8,
...
SINXRO_4_3    sinxro_i(OSC1,  OSC1, RES_HARD_RF13, ~_TRIG, counter_f_go,
