...
//--------------------------------------------------------------------------
//сигнал задержанный относительно сигнала TRIG_IN	на период count_f10[1]
//сигнал  sh3_trig
//изменение: по переднему фронту count_f10[1]
//			sh3_trig <= TRIG_IN;
//----------------------------------------------------------------------------
/*
...
always @(posedge HARD_RESET, negedge  count_f10[1])
begin
if(HARD_RESET == 1)
begin
sh4_trig <= 0; 
