...
//wire first_lock/* synthesis keep */;
//wire rs_LOCK/* synthesis keep */;
...
//
//--------------------------------------------------------------
module TEST_AIN(input HARD_RESET,input CLK, input LOCK ,input INC_COUNT, input LOAD, input _MTR_RST, output [7 : 0]ADC_OUT);
reg hi_lo;
reg [15 : 0]count;
reg s_hi_lo;
reg s_inc_count;
